...
class QSFPUtility:
    ...
    def _check_qsfp_port(self, port):
        if port not in range(QSFP.MAX_PORT):                
            raise ValueError("Port number({0}) is out of range (0-{1})".format(port, QSFP.MAX_PORT-1))
    ...
    def get_presence(self, port_num):
        try:
            ...
            result = self.cpld.qsfp_get_presence(port_num)
    ...
    def get_interrupt(self, port_num):
        try:
            ...
            result = self.cpld.qsfp_get_interrupt(port_num)
    ...
    def get_lp_mode(self, port_num):
        try:
            ...
            result = self.cpld.qsfp_get_lp_mode(port_num)
    ...
    def get_reset(self, port_num):
        try:
            ...
            result = self.cpld.qsfp_get_reset(port_num)
